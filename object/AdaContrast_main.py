...
from AdaContrast_source import train_source_domain
from AdaContrast_target import train_target_domain as train_target_adacontrast
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    work_dir = os.path.join(args.workdir, args.data.dataset, args.memo) #os.getcwd()
